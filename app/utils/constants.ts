...
/*
 * OpenRouter is Exobase's primary BYO-model flow (one key unlocks nearly every model),
 * so it's the default provider/model pairing rather than whichever provider happened
 * to register first (see LLMManager.getDefaultProvider).
 */
